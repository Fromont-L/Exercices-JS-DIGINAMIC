...
function getUtilisateurs() {
    ...
    req.open('GET', 'https://digicode.cleverapps.io/utilisateurs/' + idCreateur, true);
...
function afficherUtilisateurs(listeUtilisateurs) {
    ...
    listeUtilisateurs.forEach(utilisateur => {
        ...
        tr.innerHTML = `
            ...
            <td>
                <button class="btn btn-danger" onclick="confirmerModification(${utilisateur.id})">M</button>
...
function deleteUtilisateur(id) {
    try {
        fetch(`https://digicode.cleverapps.io/utilisateurs/${idCreateur}/${id}`, { method: "DELETE" })
...
function getUtilisateurById(id) {
    try {
        const response = fetch(`https://digicode.cleverapps.io/utilisateurs/${idCreateur}/${id}`);
